...
for issue in issues:
    ...
    # print(dt1,dt2)
    dt1 = datetime(2022, 7, 6, 0, 0, 0)
    dt2 = datetime(2022, 7, 7, 23, 59, 0)
    ...
    with open("issues_commit_summarization_individual_1.json",'a') as f:
        f.write(json_string + '\n')       
...
import json
with open("issues_commit_summarization_1.json",'a') as f:
